...
function displayTasks() {
    ...
    document.querySelectorAll('.delete').forEach(btn => btn.addEventListener('click', () => deleteTask(Number(btn.dataset.index))));
    document.querySelectorAll('.done').forEach(btn => btn.addEventListener('click', () => taskCompleted(Number(btn.dataset.index))));
    document.querySelectorAll('.update').forEach(btn => btn.addEventListener('click', () => setValues(Number(btn.dataset.index))));
}
// Clear input fields
